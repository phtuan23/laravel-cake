        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="blog__item">
                    <div class="blog__item__pic set-bg" data-setbg="{{url('public/main')}}/img/blog/blog-1.jpg">
                ...
                <div class="blog__item">
                    <div class="blog__item__pic set-bg" data-setbg="{{url('public/main')}}/img/blog/blog-2.jpg">
                        <div class="blog__pic__inner">
                            <div class="label">Recipes</div>
                            <ul>
                                <li>By <span>James Myers</span></li>
                ...
                <div class="blog__item">
                    <div class="blog__item__pic set-bg" data-setbg="{{url('public/main')}}/img/blog/blog-3.jpg">
                        <div class="blog__pic__inner">
                            <div class="label">Recipes</div>
                            <ul>
                                <li>By <span>James Myers</span></li>
                ...
                <div class="blog__item">
                    <div class="blog__item__pic set-bg" data-setbg="{{url('public/main')}}/img/blog/blog-4.jpg">
                        <div class="blog__pic__inner">
                            <div class="label">Recipes</div>
                            <ul>
                                <li>By <span>James Myers</span></li>
