                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <div id="image_description">
                                        @foreach($product->image_description as $img_des)
                                            <img src="{{url('public/upload')}}/{{$img_des->image}}" width="15.6%" class="mt-2">
                                        @endforeach
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="summernote" rows="5" cols="5" class="form-control" name="description">{!!$product->description!!}</textarea>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group ">
                                    <label class="col-form-label font-weight-bold">TÊN SẢN PHẨM</label>
                                    <input autocomplete="off" type="text" class="form-control" name="name" placeholder="NHẬP TÊN SẢN PHẨM" value="{{$product->name}}">
                                </div>
                                <div class="form-group product_image text-center">
                                    ...
                                    <img src="{{url('public/upload')}}/{{$product->image}}" width="90%" class="mt-2" id="image_product">
                                </div>
                                <div class="form-group">
                                    <label class="col-form-label font-weight-bold">GIÁ SẢN PHẨM</label>
                                    <input autocomplete="off" type="text" class="form-control" name="price" placeholder="NHẬP GIÁ SẢN PHẨM" value="{{$product->price}}">
                                </div>
                                <div class="form-group">
                                    <label class="col-form-label font-weight-bold">GIÁ KHUYẾN MÃI</label>
                                    <input autocomplete="off" type="text" class="form-control" name="sale_price" placeholder="NHẬP GIÁ KHUYẾN MÃI" value="{{$product->sale_price}}">
                                </div>
                                <div class="form-group">
        ...
        if($.inArray(type,validType) < 0 ){
            ...
            if(file){
                ...
                reader.onload = function(){
                    $("#image_product").attr('src', reader.result);
                }
