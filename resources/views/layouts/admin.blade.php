...
<head>
    ...
    <!-- font-awesome-n -->
    <link rel="stylesheet" type="text/css" href="{{url('public/admin')}}/assets/css/font-awesome-n.min.css">
    <link rel="stylesheet" type="text/css" href="{{url('public/admin')}}/assets/css/font-awesome.min.css">
    <!-- scrollbar.css -->
...
<body>
            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    <div class="navbar-logo">
                        ...
                        <a href="index.html">
                            <img class="img-fluid" src="{{url('public/admin')}}/assets/images/logo.png" alt="Theme-Logo" />
                        </a>
                    ...
                    <div class="navbar-container container-fluid">
                        ...
                        <ul class="nav-right">
                            <li class="header-notification">
                                ...
                                <ul class="show-notification">
                                    ...
                                    <li class="waves-effect waves-light">
                                        <div class="media">
                                            <img class="d-flex align-self-center img-radius" src="{{url('public/admin')}}/assets/images/avatar-2.jpg" alt="Generic placeholder image">
                                    ...
                                    <li class="waves-effect waves-light">
                                        <div class="media">
                                            <img class="d-flex align-self-center img-radius" src="{{url('public/admin')}}/assets/images/avatar-4.jpg" alt="Generic placeholder image">
                                            <div class="media-body">
                                    ...
                                    <li class="waves-effect waves-light">
                                        <div class="media">
                                            <img class="d-flex align-self-center img-radius" src="{{url('public/admin')}}/assets/images/avatar-3.jpg" alt="Generic placeholder image">
                                            <div class="media-body">
                            ...
                            <li class="user-profile header-notification">
                                <a href="#!" class="waves-effect waves-light">
                                    <img src="{{url('public/admin')}}/assets/images/avatar-4.jpg" class="img-radius" alt="User-Profile-Image">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <div class="">
                                <div class="main-menu-header">
                                    <img class="img-80 img-radius" src="{{url('public/admin')}}/assets/images/avatar-4.jpg" alt="User-Profile-Image">
                            ...
                            <div class="pcoded-navigation-label">Manager</div>
                            @foreach($menu as $m)
                            <ul class="pcoded-item pcoded-left-item active">
                                <li class="pcoded-hasmenu {{ Request::routeIs($m['route']) ? 'active' : '' }}">
                                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="{{$m['icon']}}"></i><b>BC</b></span>
                                        <span class="pcoded-mtext">{{$m['name']}}</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    @foreach($m['items'] as $i)
                                    <ul class="pcoded-submenu">
                                        <li class="{{ Request::routeIs($i['route']) ? 'active' : '' }}">
                                            <a href="{{route($i['route'])}}" class="waves-effect waves-dark">
                                                <span class="pcoded-mtext">{{$i['name']}}</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                    </ul>
    ...
    <script src="{{url('public/admin')}}/assets/js/vertical/vertical-layout.min.js "></script>
